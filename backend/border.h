...
int border_detection_sobel(Image *image, Image *result_image){
    ...
    x_derivate[0][0] = 1; x_derivate[0][1] = 0; x_derivate[0][2] = -1;
    x_derivate[1][0] = 2; x_derivate[1][1] = 0; x_derivate[1][2] = -2;
    x_derivate[2][0] = 1; x_derivate[2][1] = 0; x_derivate[2][2] = -1;

    y_derivate[0][0] =  1; y_derivate[0][1] =  2; y_derivate[0][2] =  1;
    y_derivate[1][0] =  0; y_derivate[1][1] =  0; y_derivate[1][2] =  0;
    y_derivate[2][0] = -1; y_derivate[2][1] = -2; y_derivate[2][2] = -1;
